...
import AddConsultant from "./components/AdminPages/ConsultantManagement/AddConsultant";
import EditConsultant from "./components/AdminPages/ConsultantManagement/EditConsultant";
...
import SystemSettingsResetPassword from "./components/AdminPages/SystemsSetting/SystemSettings-ResetPassword";
import SystemSettingsSummaryEmail from "./components/AdminPages/SystemsSetting/SystemSettings-SummaryEmail";
      ...
      <AuthContextProvider>
        <>
          {!shouldHideSidebar &&
            ...
            !isSegmentCorrect(location.pathname, "reset-password") &&
            location.pathname !== "/open-email" && <SideBar role={userRole} />}
          <Routes>
            ...
            />
            <Route
              path="/system-settings_reset-password"
              element={
                <ProtectedRoute
                  element={<SystemSettingsResetPassword />}
                  allowedRoles={["Admin"]}
                />
              }
            />
            <Route
              path="/system-settings_summary-email"
              element={
                <ProtectedRoute
                  element={<SystemSettingsSummaryEmail />}
                  allowedRoles={["Admin"]}
                />
              }
            />
